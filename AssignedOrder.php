...
echo "<a href='http://192.234.204.46/wxprogram/AssignedOrder.php'><button style='margin-left:20px;margin-bottom:20px;color:red;'>Assigned Orders</button></a>";
...
$query = "SELECT * FROM customer_info where status ='Assigned'";
...
echo "</table>";
echo "<a href='http://192.234.204.46/wxprogram/AssignedOrder.php'><button style='margin-top:30px'>Refresh</button></a>";
