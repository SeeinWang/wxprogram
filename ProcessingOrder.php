...
echo "<a href='http://192.234.204.46/wxprogram/PaidOrder.php'><button style='margin-left:30px;margin-bottom:20px'>Paid Orders</button></a>";
...
echo "<a href='http://192.234.204.46/wxprogram/ProcessingOrder.php'><button style='margin-left:20px;margin-bottom:20px;color:red;'>Processing Orders</button></a>";
...
$query = "SELECT * FROM customer_info where status ='Processing'";
...
echo "</table>";
echo "<a href='http://192.234.204.46/wxprogram/ProcessingOrder.php'><button style='margin-top:30px'>Refresh</button></a>";
