...
echo "<a href='visaOrderData.php'><button style='margin-left:30px;margin-bottom:20px'>All Orders</button></a>";
...
echo "<a href='visaMemberOrderData.php?user=teamOne'><button style='margin-left:30px;margin-bottom:20px;color:".$teamonecolor."'>Team One Orders</button></a>";
echo "<a href='visaMemberOrderData.php?user=teamTwo'><button style='margin-left:20px;margin-bottom:20px;color:".$teamtwocolor."''>Team Two Orders</button></a> </br>";
...
echo "</table>";
echo "<a href='http://192.234.204.46/wxprogram/visaMemberOrderData.php?user=".$name."'><button style='margin-top:20px'>Refresh</button></a>";
