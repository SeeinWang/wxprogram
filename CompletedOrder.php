...
echo "<a href='http://192.234.204.46/wxprogram/CompletedOrder.php'><button style='margin-left:20px;margin-bottom:20px;color:red;'>Completed Orders</button></a></br>";
...
$query = "SELECT * FROM customer_info where status ='Done'";
...
echo "</table>";
echo "<a href='http://192.234.204.46/wxprogram/CompletedOrder.php'><button style='margin-top:30px'>Refresh</button></a>";
